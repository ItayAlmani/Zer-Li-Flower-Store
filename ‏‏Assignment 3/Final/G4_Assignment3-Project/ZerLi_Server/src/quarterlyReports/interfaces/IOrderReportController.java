...
public interface IOrderReportController {
	 ...
	 * {@link analyzeOrders}
	 */
	ArrayList<Object> produceOrderReport(LocalDate date, BigInteger storeID) throws Exception;
	/**
	...
	/**
	 * <p>A function that inserts a row into a orderreport table in DB</p>
	 ...
	 * @param obj - an array list of objects the represent row in orderreport table in DB
	 ...
	 */
	ArrayList<Object> getOrderReport(ArrayList<Object> arr) throws Exception;
